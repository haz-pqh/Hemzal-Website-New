        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <a
              ...
              className="p-6 rounded-3xl bg-white hover:bg-[#fdb913]/50 border border-neutral-200/90 hover:border-[#fdb913] transition-all duration-300 flex items-center gap-4 group block shadow-xl shadow-black/10"
            >
