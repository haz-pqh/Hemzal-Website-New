  ...
  return (
    <section id="hubungi" className="py-20 bg-[#09090c]/10 backdrop-blur-sm relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Collapsible FAQ Accordion Section (Maintained Dark Theme) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          {/* Left Column: Direct Info Boxes (Light Theme) */}
          <div className="lg:col-span-5 space-y-4">
            ...
            <a
              ...
              className="p-6 rounded-3xl bg-white hover:bg-[#fdb913]/50 border border-neutral-200/90 hover:border-[#fdb913] transition-all duration-300 flex items-center gap-4 group block shadow-xl shadow-black/10 hover:text-white"
            >
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500">Tekan untuk sembang terus bersama admin</p>
              </div>
            </a>
            ...
            <div className="p-6 rounded-3xl bg-white border border-neutral-200/90 flex items-center gap-4 shadow-xl shadow-black/10">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500">Untuk pertanyaan media & rasmi</p>
              </div>
            </div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-neutral-500">Isi maklumat anda dan kami akan menghubungi anda segera.</p>
                </div>
