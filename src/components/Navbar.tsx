    ...
    <header className="fixed top-0 left-0 w-full z-40 select-none">
      ...
      <nav
        ...
        className={`w-full transition-all duration-300 ${
          isScrolled
            ? 'bg-white/95 backdrop-blur-md py-2.5 shadow-lg border-b border-neutral-200'
            : 'bg-white/85 backdrop-blur-md py-3.5 border-b border-neutral-200/60'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          ...
          >
            ...
            <div className="flex flex-col items-start leading-none">
              ...
              <span className="text-[10px] sm:text-[11px] font-extrabold italic tracking-tight text-neutral-600 uppercase font-['Montserrat',sans-serif] -mt-0.5">
                Crispy Chicken
              </span>
            </div>
          </a>
          ...
          <div className="hidden lg:flex items-center gap-1 xl:gap-2">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="relative px-3.5 py-2 rounded-xl text-sm font-semibold text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100 transition-all flex items-center gap-1.5 group"
              >
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="hidden md:inline-flex items-center gap-2 text-xs font-semibold text-neutral-600 hover:text-neutral-900 px-3.5 py-2.5 rounded-xl border border-neutral-200 hover:border-[#FDB913]/60 bg-neutral-50 hover:bg-neutral-100 transition-all cursor-pointer shadow-sm"
            ...
            <button
              ...
              className="relative flex items-center justify-center gap-2 bg-neutral-900 hover:bg-neutral-800 text-white px-3.5 py-2.5 rounded-xl border border-neutral-900 hover:border-[#FDB913]/50 transition-all shadow-md cursor-pointer group shrink-0"
            ...
            >
              ...
              {cartCount > 0 ? (
                ...
                <span className="hidden xl:inline text-[11px] text-neutral-300 font-medium">(0)</span>
              )}
            </button>
            ...
            <button
              ...
              className="lg:hidden flex items-center justify-center w-10 h-10 rounded-xl bg-neutral-900 hover:bg-neutral-800 active:bg-neutral-700 text-white border border-neutral-900 hover:border-[#FDB913]/50 transition-all shadow-md cursor-pointer shrink-0"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white/98 backdrop-blur-xl border-b border-neutral-200 px-5 py-5 space-y-4 shadow-2xl animate-in slide-in-from-top-3 duration-200 max-h-[calc(100vh-100px)] overflow-y-auto">
            <div className="flex flex-col space-y-1 font-semibold text-sm">
              <a
                href="#home"
                onClick={() => setMobileMenuOpen(false)}
                className="text-neutral-700 hover:text-[#E31E24] py-2.5 px-3 rounded-lg hover:bg-neutral-100 transition-colors flex items-center justify-between"
              >
            ...
            <div className="pt-3 border-t border-neutral-200 flex flex-col gap-2.5">
              ...
              <button
                ...
                className="w-full text-center py-2.5 rounded-xl border border-neutral-200 hover:border-[#FDB913]/60 text-neutral-700 font-bold text-xs bg-neutral-50"
              >
                🤝 Katering Kenduri & Francais
              </button>
              <a
                href="tel:+60123456789"
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-emerald-50 border border-emerald-300 text-emerald-700 font-bold text-xs"
              >
                <Phone className="w-4 h-4 text-emerald-600" /> Hotline Dapur: +60 12-345 6789
              </a>
            </div>
          </div>
        )}
